...
namespace Domingo_Roof_Works.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public MaterialsController(Domingo_Roof_WorksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaterialId,Description")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaterialId,Description")] Material material)
        {
